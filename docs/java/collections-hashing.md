...
## Hash Table
![images](/images/java/20250509-collections-hashing-1.png)
_출처 : https://en.wikipedia.org/wiki/Hash_table_
...
![images](/images/java/20250509-collections-hashing-3.png)
_출처 : https://en.wikipedia.org/wiki/Hash_table_
...
- **충돌 발생 시 다른 해시 함수를 추가로 적용**하여, 빈 슬롯을 찾는 간격을 불규칙하게 구성하는 방식
...
![images](/images/java/20250509-collections-hashing-2.png)
_출처 : https://en.wikipedia.org/wiki/Hash_table_
